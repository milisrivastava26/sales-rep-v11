...
export const leadsItems: DropdownItem[] = [
  { label: "Manage Leads", href: "/manage-leads-v1", roles: ["ROLE_USER", "ROLE_ADMIN", "ROLE_MANAGER", "ROLE_TICKET_RESOLVER"] },
  { label: "Inbound Whatsapp Messages", href: "/inbound-whatsapp-messages", roles: ["ROLE_USER", "ROLE_ADMIN", "ROLE_MANAGER", "ROLE_TICKET_RESOLVER"] },
  { label: "Smart View", href: "/smart-view", roles: ["ROLE_USER", "ROLE_ADMIN", "ROLE_MANAGER", "ROLE_TICKET_RESOLVER"] },
  ...
  { label: "Super Bot Callback Details", href: "/superbot-details", roles: ["ROLE_MANAGER", "ROLE_ADMIN", "ROLE_USER", "ROLE_TICKET_RESOLVER"] },
  { label: "Lead Discount", href: "/lead-discount", roles: ["ROLE_DISCOUNT", "ROLE_DISCOUNT_VIEW", "ROLE_ADMIN", "ROLE_TICKET_RESOLVER"] },
];

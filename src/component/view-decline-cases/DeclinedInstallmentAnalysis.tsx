...
import DeclinedFeeDetails from "./DeclinedFeeDetails";
import { transformDeclinedInstallmentTypePayload } from "../../util/actions/transformInstallmentFormPayload";
...
const DeclinedInstallmentAnalysis: React.FC = () => {
  ...
  const { isLoading: isLoadingForLockOffer, responseOfLockLeadOffer } =
    useSelector((state: RootState) => state.lockLeadOffer);
  ...
  const handleLockOffer = () => {
    ...
    if (isValid === false) {
      ...
      const finalInstallmentPayload = transformDeclinedInstallmentTypePayload(
  ...
  return (
    <div className="bg-white  mt-4">
      ...
      {!isLoadingForInstallmentCalculation &&
        newInstallmentDetailsResponse.length !== 0 && (
          <>
            ...
            <div className="flex justify-end px-5 pb-5 my-5">
              <>
                <button
                  className={` text-white bg-blue-600 px-4 py-2 rounded bottom-[16px] right-[16px]`}
...
export default DeclinedInstallmentAnalysis;

...
const FeeDetails: React.FC = () => {
  ...
  const { isLoading: isLoadingForLeadOfferDetails, leadOfferHistoryByOfferIdResponse } = useSelector(
  ...
  useEffect(() => {
    ...
    } else if (!isLoadingForLeadOfferDetails && Object.keys(leadOfferHistoryByOfferIdResponse || {}).length === 0) {
  ...
  }, [isLoadingForLeadOfferDetails, FeeDetailsV2Response, leadOfferHistoryByOfferIdResponse, packageDealByLeadCaptureIdResponse]);

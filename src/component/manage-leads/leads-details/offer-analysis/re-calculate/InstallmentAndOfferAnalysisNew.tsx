...
//     registrationFeeObject &&
//     registrationFeeObject.status === true &&
...
//               {(shouldDisplayLockButton || lockOfferStatus==="void") && (
//                 <>
//                   <button
//                     className={` ${
//                       shouldDisplayLockButton ? "bg-blue-600" : "bg-red-600"
//                     } text-white px-4 py-2 rounded bottom-[16px] right-[16px]`}
//                     onClick={
//                       shouldDisplayLockButton ? handleLockOffer : undefined
//                     }

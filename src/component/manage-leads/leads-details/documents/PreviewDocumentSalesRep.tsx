...
const PreviewDocumentSalesRep: React.FC<PreviewDocumentProps> = ({ name, leadCaptureId, coreDocAttachmentTypeId, coreDocAttachmentTypeName }) => {
...
export default PreviewDocumentSalesRep;

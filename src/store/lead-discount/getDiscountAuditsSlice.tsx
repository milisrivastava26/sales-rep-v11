...
//AsyncThunk -> API call
export const getDiscountAudits = createAsyncThunk<any>(
    "crm/lead/dashboard/getDiscountAudits",
    async (_, thunkAPI) => {
        try {
            const response = await coreLeadCaptureApi.get("api/crm/lead/unprocessed-discount-audits");
...
export const {
    resetResponseForGetDiscountAudits,
    triggeredGetDiscountAuditsAction,
} = getDiscountAuditsSlice.actions;
